...
LDFLAGS ?= -L$(LVGL_DIR)/lib -Wl,-rpath,'/mnt/UDISK/lib:/mnt/app/lib:/mnt/app/dendro/lib' -Wl,--disable-new-dtags -llvgl -lavcodec -lavdevice -lavfilter -lavformat -lavutil -lpostproc -lswresample -lswscale -lz -lasound -lfreetype -ltimidity -lpinyinime -lcurl -lssl -lcrypto
