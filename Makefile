...
LDFLAGS ?= -L$(LVGL_DIR)/lib -Wl,-rpath,'/mnt/UDISK/lib:/mnt/app/lib:/mnt/app/dendro/lib' -Wl,--disable-new-dtags -lm -lpthread -llvgl -lavcodec -lavdevice -lavfilter -lavformat -lavutil -lpostproc -lswresample -lswscale -lz -lasound -lfreetype -ltimidity #-lcurl -lssl -lcrypto
